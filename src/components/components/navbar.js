	...
	return(
        <nav id='nav' className='nav hidden'>
            ...
            <div id='socialList' className='socialList'>
                <a title='Twitter' href='https://twitter.com/kawaiitrashpodc' target="_blank" className='twitter socialIcon'>
                ...
                <a title='Soundcloud' href='https://soundcloud.com/kawaiitrashpodcast' target="_blank" className='soundcloud socialIcon'>
                ...
                <a title='itunes' href='https://itunes.apple.com/us/podcast/kawaii-trash/id1375581186?mt=2' target="_blank" className='itunes socialIcon'>
                ...
                <a title='Spotify' href='https://open.spotify.com/show/7I0S4KzfyyfcRwVmwGmdT4' target="_blank" className='spotify socialIcon'>
                ...
                <a title='RSS' href="http://feeds.soundcloud.com/users/soundcloud:users:427691895/sounds.rss" target="_blank" className='rss socialIcon'>
